      ...
      <div className="rounded-2xl border-2 border-green-300 p-5 text-center space-y-3" style={{ background: "#f0fdf4" }}>
        <div className="flex items-center justify-center gap-3">
          ...
          <div className="text-left">
            <p className="font-bold text-green-900">You&apos;ve completed the walkthrough!</p>
            <p className="text-green-800 text-sm">That&apos;s the full CountyConsent workflow — from inviting your team to having everything ready on the day of travel.</p>
          </div>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-1">
          <button onClick={onBack} className="text-sm font-semibold text-green-800 hover:text-green-900 px-4 py-2 rounded-xl border border-green-300 bg-white hover:bg-green-50 transition-colors">
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between gap-3 pt-2 flex-wrap">
        ...
        {sent ? (
          ...
          <button onClick={onNext}
            className="inline-flex items-center gap-2 text-slate-400 text-sm font-semibold px-5 py-2.5 rounded-xl border border-slate-200 cursor-default"
            tabIndex={-1}>
            Next: create a trip
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
          </button>
